...
def display_employee_card(employee_data, index):
    ...
    # employee_data = employee_data.fillna(np.nan)
    with st.container():
        ...
        if not st.session_state[f"edit_mode_{index}"]:
            ...
            with st.form(f"edit_form_{index}"):
                ...
                new_status = st.text_input("Status", value=employee_data["Status"])
                new_contact = st.text_input(
                    "Contact No.", value=employee_data["Contact No."]
                )
                new_company = st.text_input("Company", value=employee_data["Company"])
                new_country = st.text_input("Country", value=employee_data["Country"])
                ...
                new_posting_date = st.date_input(
                    "Posting Date (DD-MM-YY)", value=employee_data["Posting Date"]
                )
                ...
                new_tier = st.text_input("Tier", value=employee_data["Tier"])
                ...
                if submitted:
                    ...
                    df.at[index, "Company"] = new_company
                    ...
                    df.at[index, "Golf Handicap"] = int(new_golf_handicap)
                    df.at[index, "Dietary Restrictions"] = new_dietary
